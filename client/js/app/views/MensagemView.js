...
System.register(["./View.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      _export("MensagemView", MensagemView = /*#__PURE__*/function (_View) {
        _inherits(MensagemView, _View);
        var _super = _createSuper(MensagemView);
        ...
        _createClass(MensagemView, [{
          ...
          value: function template(model) {
            return model.texto && "<p class=\"alert alert-info\">".concat(model.texto, "</p>");
          }
        }]);
        return MensagemView;
      }(View));
